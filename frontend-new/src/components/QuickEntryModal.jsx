...
//                       BDG-{b.budget_id} (FY {b.budget_year})
//                     </option>
//                   ))}
//                 </select>
//               </div>
      ...
      <div className="modal-box">
        ...
        {tab === 0 && (
          <div className="modal-form">
            <div className="form-grid-2">
              ...
              <select value={expForm.department_id}
              ...
              <select value={expForm.budget_id}
        ...
        {tab === 1 && (
          <div className="modal-form">
            ...
            <select value={comForm.department_id}
              onChange={e => setComForm({ ...comForm, department_id: e.target.value })}>
              <option value="">Department</option>
              {depts.map(d => (
                <option key={d.department_id} value={d.department_id}>{d.department_name}</option>
              ))}
            ...
            <button onClick={handleSubmit}>
              {loading ? "Saving..." : "Submit Commitment"}
            </button>
        ...
        {tab === 2 && (
          <div className="modal-form">
            ...
            <select value={budForm.department_id}
